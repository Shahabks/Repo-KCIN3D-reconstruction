...
mdpathpv_OUT0M = cathy+ '/'+'Outputs'+'/'+ prnamepv+"_OUT0M" +'.xlsm'
mdpathpv_OUT1M = cathy+ '/'+ 'Outputs'+'/'+ prnamepv+"_OUT1M" +'.xlsm'
mdpathpv_OUT2M = cathy+ '/'+ 'Outputs'+'/'+ prnamepv+"_OUT2M" +'.xlsm'
source = cathy+ '/'+ 'sbinCAD.xlsm'
generator = cathy+ '/'+ 'Outputs'+'/'+ 'generator.xlsm'
generator1 = cathy+ '/'+ 'Outputs'+'/'+ 'generatorCAD.xlsm'
